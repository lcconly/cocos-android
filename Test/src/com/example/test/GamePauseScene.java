...
public class GamePauseScene extends CCLayer {
	...
	public CCSprite get_continue(){
		return sprite_pause_continue;
	}
	public CCSprite get_back(){
		return sprite_pause_back;
	}
	public CCSprite get_home(){
		return sprite_pause_home;
	}
